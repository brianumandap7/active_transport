"""
Django settings for active_transport project.
...
SECRET_KEY = "django-insecure-p(4$+4+tlkb0#^cfvq@6s%=w%cwhbg3c$(73&!4o!8jf9%s@88"
...
ROOT_URLCONF = "active_transport.urls"
